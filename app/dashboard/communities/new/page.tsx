...
import type { Community, CommunityVisibility } from "../communityStore";
import { getCommunities, saveCommunity } from "../communityStore";
...
export default function CommunityCreatePage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (existing.some((community) => community.slug === payload.slug)) {
        throw new Error("Slug finnes allerede. Velg en annen.");
      }
